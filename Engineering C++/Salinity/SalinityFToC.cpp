/*
	...
	A program to compute the final freezing temperature and convert F to Celsius. 
*/
#include <iostream>
#include <iomanip>
...
int main()
{
    ...
    farToCen = (f_b - 32) * (5.0/9.0);

    cout << "New freezing temperature in degrees C: "
    << fixed << setprecision(1) << farToCen << endl;
